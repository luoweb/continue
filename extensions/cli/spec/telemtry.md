# AICODER anonymous Posthog telemetry

## Behavior

- Used by AICODER for product metrics (not used by customers)
...
- Event user ids are the AICODER user id is signed in, or a unique machine id if not
