...
import { AICODER_ASCII_ART, getDisplayableAsciiArt } from "./asciiArt.js";
...
describe("asciiArt", () => {
  ...
  describe("getDisplayableAsciiArt", () => {
    it("should return full ASCII art when terminal is wide enough", () => {
      ...
      expect(result).toBe(AICODER_ASCII_ART);
    });

    it("should return AI ASCII art version when terminal is too narrow", () => {
