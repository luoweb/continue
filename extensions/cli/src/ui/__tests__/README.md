...
This directory contains a comprehensive testing framework for the AICODER CLI's Terminal User Interface (TUI) that supports running tests in both normal (local) and remote modes.
