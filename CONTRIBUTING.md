...
- [Contributing to AICODER](#contributing-to-continue)
  - [Table of Contents](#table-of-contents)
- [❤️ Ways to Contribute](#️-ways-to-contribute)
  - [👋 AICODER Contribution Ideas](#-continue-contribution-ideas)
  ...
  - [🧑‍💻 Contributing Code](#-contributing-code)
    - [Environment Setup](#environment-setup)
      ...
      - [Fork the AICODER Repository](#fork-the-continue-repository)
      - [VS Code](#vs-code)
        - [Debugging](#debugging)
      - [JetBrains](#jetbrains)
  ...
  - [📐 AICODER Architecture](#-continue-architecture)
    - [AICODER VS Code Extension](#continue-vs-code-extension)
    - [AICODER JetBrains Extension](#continue-jetbrains-extension)
  - [Contributor License Agreement](#contributor-license-agreement-cla)

# ❤️ Ways to Contribute

## 👋 AICODER Contribution Ideas

[This GitHub project board](https://github.com/orgs/continuedev/projects/2) is a list of ideas for how you can
contribute to AICODER. These aren't the only ways, but are a great starting point if you are new to the project. You
...
AICODER is quickly adding features, and we'd love to hear which are the most important to you. The best ways to suggest
an enhancement are:
...
- Join the [AICODER Discord](https://discord.gg/NWtdYexhMs) and tell us about your idea in the `#feedback` channel

## 📖 Updating / Improving Documentation

AICODER is continuously improving, but a feature isn't complete until it is reflected in the documentation! If you see
...
#### Fork the AICODER Repository

1. Go to the [AICODER GitHub repository](https://github.com/continuedev/continue) and fork it to your GitHub account.
...
To keep the AICODER codebase clean and maintainable, we expect the following from our own team and all contributors:
...
AICODER uses [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode) to format
JavaScript/TypeScript. Please install the Prettier extension in VS Code and enable "Format on Save" in your settings.

### Theme Colors

AICODER has a set of named theme colors that we map to extension colors and tailwind classes, which can be found in [gui/src/styles/theme.ts](gui/src/styles/theme.ts)
...
AICODER has support for more than a dozen different LLM "providers", making it easy to use models running on OpenAI,
...
While any model that works with a supported provider can be used with AICODER, we keep a list of recommended models
...
- LLM Providers: Since many providers use their own custom strings to identify models, you'll have to add the
  translation from AICODER's model name (the one you added to `index.d.ts`) and the model string for each of these
...
- [Prompt Templates](./core/llm/autodetect.ts) - In this file you'll find the `autodetectTemplateType` function. Make
  ...
  the chat template for that model is already built in AICODER. If not, you will have to add the template type and
