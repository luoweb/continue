...
<Step title="Install Sanity CLI">
 ...
 <Warning>
  To use agents in headless mode, you need a [Continue API key](https://hub.roweb.cn/settings/api-keys) and proper environment variable configuration.
  </Warning>
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Load the Pre-Built Agent">
        Visit the [Sanity Agent Config](https://hub.roweb.cn/continuedev/sanity-agent-config) on Continue Hub and click **"Install Config"** or run:
        ...
        This agent includes:
        - **[Sanity MCP](https://hub.roweb.cn/sanity/sanity-mcp)** pre-configured and ready to use
...
<Steps>
  ...
  <Step title="Connect Sanity MCP via Continue Hub">
    Visit the [Sanity MCP on Continue Hub](https://hub.roweb.cn/sanity/sanity-mcp) and click **"Install"** to add it to the agent you created in the step above.
    ...
    <Tip>
      **Alternative installation methods:**
      ...
      2. **With config**: Use [Sanity MCP Config](https://hub.roweb.cn/sanity/sanity-mcp-config) for environment variable setup
    ...
    <Info>
      **Authentication Options:**
      ...
      See [Sanity MCP Config](https://hub.roweb.cn/sanity/sanity-mcp-config) for environment variable setup.
    </Info>
...
<Info>
  The workflow uses the [Sanity Agent Config](https://hub.roweb.cn/continuedev/sanity-agent-config) with environment variable authentication via [Sanity MCP Config](https://hub.roweb.cn/sanity/sanity-mcp-config). This enables headless mode operation without OAuth browser authentication.
</Info>
...
<Info>
  Environment variables enable the MCP to authenticate without OAuth browser prompts. The [Sanity MCP Config](https://hub.roweb.cn/sanity/sanity-mcp-config) documentation provides detailed setup instructions for all required variables.
</Info>
...
<Check>
  **Verification Steps:**
  - Sanity MCP is installed via [Continue Hub](https://hub.roweb.cn/sanity/sanity-mcp)
