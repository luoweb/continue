    ...
    **Perfect for:** Immediate error analysis with AI-powered root cause detection and built-in debugging
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Sentry Continuous AI Agent](https://hub.roweb.cn/continuedev/sentry-continuous-ai) on Continue Hub and click **"Install Agent"** or run:
...
- Integrate [Slack MCP](https://hub.roweb.cn/slack/slack-mcp) for error alerts
