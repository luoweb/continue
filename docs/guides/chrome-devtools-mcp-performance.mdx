    ...
    **Perfect for:** Immediate results with optimized prompts and built-in performance analysis
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Chrome DevTools Continuous Agent](https://hub.roweb.cn/continuedev/chrome-dev-continuous) on Continue Hub and click **"Install Agent"** or run:
        ...
        - **[Chrome DevTools MCP](https://hub.roweb.cn/google/chrome-devtools-mcp)** for reliable browser automation
      </Step>
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Add Chrome DevTools MCP to Your Assistant">
        Visit the [Chrome DevTools MCP](https://hub.roweb.cn/google/chrome-devtools-mcp) on Continue Hub and add it to your assistant, or add this to your configuration:
