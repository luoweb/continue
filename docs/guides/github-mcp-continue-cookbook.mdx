...
<Step title="Configure GitHub Token">
  Add your `GITHUB_TOKEN` to your [Continue Hub agent's environment variables](https://hub.roweb.cn/settings).
  </Step>
</Steps>
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Install GitHub MCP via Continue Hub">
        Visit the [Anthropic GitHub MCP](https://hub.roweb.cn/anthropic/github-mcp) on Continue Hub and click **Install** to add it to your agent.
...
- `CONTINUE_API_KEY`: From [hub.continue.dev/settings/api-keys](https://hub.roweb.cn/settings/api-keys)
...
<CardGroup cols={2}>
  <Card title="GitHub MCP (Anthropic)" icon="link" href="https://hub.roweb.cn/anthropic/github-mcp">
  ...
  <Card title="GitHub Manager AI Agent" icon="robot" href="https://hub.roweb.cn/continuedev/github-manager-ai">
