...
<Card title="Fastest Path to Success" icon="rocket">
  Use the pre-built [Docs Assistant - Mintlify agent](https://hub.roweb.cn/continuedev/docs-mintlify) that includes the Continue Docs MCP and is ready to use immediately.
</Card>
...
<Tabs>
  ...
  <Tab title="🛠️ Custom Agent">
    ...
    1. [Continue Docs MCP](https://hub.roweb.cn/continuedev/continue-docs-mcp)
    2. [Mintlify Technical Writing Rule](https://hub.roweb.cn/mintlify/technical-writing-rule)
...
<Steps>
  ...
  <Step title="Publish to Continue Hub">
    Share your docs MCP on [Continue Hub](https://hub.roweb.cn/new?type=mcp) so others can use it with Continue agents.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Use Docs Agent" icon="robot" href="https://hub.roweb.cn/continuedev/docs-mintlify">
