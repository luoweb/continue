...
[DeepWiki MCP](https://hub.roweb.cn/deepwiki/deepwiki-mcp) lets agent mode explore any public GitHub repository.
...
[Context7 MCP](https://hub.roweb.cn/upstash/context7-mcp) enables agent mode to search and retrieve information from public documentation:
