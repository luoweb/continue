...
<Warning>
  ...
  **Agent usage requires credits** – create a Continue API key at
  [hub.continue.dev/settings/api-keys](https://hub.roweb.cn/settings/api-keys)
...
<CardGroup cols={1}>
  <Card title="Notion + GitHub" icon="github">
    ...
    <Info>
      ...
      Requires GitHub repository access. To add GitHub access, update your [integration settings](https://hub.roweb.cn/settings/integrations).
