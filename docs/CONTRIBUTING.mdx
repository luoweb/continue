...
<Steps>
  <Step title="Install the agent from Continue Hub">
    Visit [the Docs Assistant - Mintlify in the Hub](https://hub.roweb.cn/continuedev/docs-mintlify) and click "Install" to add it to your Continue setup. This agent comes pre-configured with all our documentation standards.
...
<Steps>
  ...
  <Step title="Add the Continue Docs MCP">
    Install from Continue Hub: https://hub.roweb.cn/continuedev/continue-docs-mcp
    
    This MCP provides context about Continue's documentation structure and standards.
  </Step>
  
  <Step title="Add Mintlify formatting rules">
    Install from Continue Hub: https://hub.roweb.cn/mintlify/technical-writing-rule
...
- **Continue agent questions**: Check the [Continue Hub page](https://hub.roweb.cn/continuedev/docs-mintlify)
