...
<Tabs>
  <Tab title="Hub">
  View the [Claude Opus 4.1 model block](https://hub.roweb.cn/anthropic/claude-4-1-opus) or [Claude Sonnet 4 model block](https://hub.roweb.cn/anthropic/claude-4-sonnet) on the hub.
  </Tab>
  <Tab title="YAML">
...
<Tabs>
  <Tab title="Hub">
    <Tabs>
        <Tab title="Ollama">
        Add the [Ollama Gemma 3 27B block](https://hub.roweb.cn/ollama/gemma3-27b) from the hub
        </Tab>
        <Tab title="Together">
        Add the [Together Gemma 2 27B Instruct block](https://hub.roweb.cn/togetherai/gemma-2-instruct-27b) from the hub
        </Tab>
    </Tabs>
  </Tab>
  <Tab title="YAML">
...
<Tabs>
    <Tab title="Hub">
    Add the [OpenAI GPT-4o block](https://hub.roweb.cn/openai/gpt-4o) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs>
    <Tab title="Hub">
    Add the [xAI Grok-2 block](https://hub.roweb.cn/xai/grok-2) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs>
    <Tab title="Hub">
    Add the [Gemini 2.0 Flash block](https://hub.roweb.cn/google/gemini-2.0-flash) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs>
  <Tab title="Hub">
    <Tabs>
        <Tab title="Ollama">
    Add the [Ollama Llama 3.1 8b block](https://hub.roweb.cn/ollama/llama3.1-8b) from the hub
    </Tab>
    {/* HUB_TODO nonexistent block */}
    {/* <Tab title="LM Studio">
    Add the [LM Studio Llama 3.1 8b block](https://hub.roweb.cn/explore/models) from the hub
    </Tab> */}
    </Tabs>
  </Tab>
  <Tab title="YAML">
...
<Tabs>
  ...
  {/* <Tab title="Hub">
    <Tabs>
    <Tab title="Ollama">
    Add the [Ollama Deepseek Coder 2 16B block](https://hub.roweb.cn/explore/models) from the hub
    </Tab>
    <Tab title="LM Studio">
    Add the [LM Studio Deepseek Coder 2 16B block](https://hub.roweb.cn/explore/models) from the hub
    </Tab>
    </Tabs>
  </Tab> */}
  <Tab title="YAML">
