...
<Tip>
  **Discover LM Studio models [here](https://hub.roweb.cn/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.roweb.cn/lmstudio/qwen-qwen3-coder-30b?view=config)**
</Info>