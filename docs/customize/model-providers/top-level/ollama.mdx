...
<Tip>
  **Discover Ollama models [here](https://hub.roweb.cn/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.roweb.cn/ollama/qwen3-coder-30b?view=config)**
</Info>
