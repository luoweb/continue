...
<Tip>
  **Discover Anthropic models [here](https://hub.roweb.cn/anthropic)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.roweb.cn/anthropic/claude-4-sonnet?view=config)**
</Info>
