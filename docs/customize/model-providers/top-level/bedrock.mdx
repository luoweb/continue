...
<Tip>
  **Discover Amazon Bedrock models [here](https://hub.roweb.cn/amazon)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.roweb.cn/amazon/us-anthropic-claude-sonnet-4-20250514-v1?view=config)**
</Info>
