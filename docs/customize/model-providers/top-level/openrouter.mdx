...
<Tip>
  **Discover OpenRouter models [here](https://hub.roweb.cn/openrouter)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.roweb.cn/openrouter/qwen3-coder?view=config)**
</Info>
