...
<Tip>
  **Discover Deep Infra models [here](https://hub.roweb.cn/deepinfra)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.roweb.cn/deepinfra/qwen-qwen2.5-coder-32b-instruct?view=config)**
</Info>