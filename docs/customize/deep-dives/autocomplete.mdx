...
<Tabs>
  <Tab title="Hub">
  [Mistral Codestral model block](https://hub.roweb.cn/mistral/codestral)
  </Tab>
  <Tab title="YAML">
...
<Tabs>
  <Tab title="Hub">
  [Ollama Qwen 2.5 Coder 1.5B model block](https://hub.roweb.cn/ollama/qwen2.5-coder-1.5b)
  </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
Explore autocomplete model configurations on [the hub](https://hub.roweb.cn/explore/models?roles=autocomplete)
